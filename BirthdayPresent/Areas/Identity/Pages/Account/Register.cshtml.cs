...
namespace BirthdayPresent.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Employee CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Employee)}'. Ensure that '{nameof(Employee)}' is not an abstract class and has a parameterless constructor.");
            }
        }
