        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHasABirthDay = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthdayEmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    VotingYear = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VoteSessions_AspNetUsers_BirthdayEmployeeId",
                        column: x => x.BirthdayEmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VoteSessions_AspNetUsers_InitiatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoteSessions_BirthdayEmployeeId_VotingYear",
                table: "VoteSessions",
                columns: new[] { "BirthdayEmployeeId", "VotingYear" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VoteSessions_InitiatorId",
                table: "VoteSessions",
                column: "InitiatorId");
        }
